...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  if (showDashboardLayout) {
    return (
      <div className="h-screen bg-linear-to-br from-background via-background to-muted/20 dark:from-background dark:via-background dark:to-muted/10 flex overflow-hidden">
        {/* Sidebar */}
        <Sidebar
          isOpen={sidebarOpen}
