  ...
  const spacingOptions = [
    {
      id: "compact",
      name: "Compact",
      description: "Tight spacing, fits more content",
    },
  ...
  const sections: Section[] = [
    {
      id: "experience",
      name: "Experience",
      enabled: sectionVisibility.experience,
    },
    {
      id: "education",
      name: "Education",
      enabled: sectionVisibility.education,
    },
    ...
    { id: "projects", name: "Projects", enabled: sectionVisibility.projects },
    {
      id: "certifications",
      name: "Certifications",
      enabled: sectionVisibility.certifications,
    },
    {
      id: "languages",
      name: "Languages",
      enabled: sectionVisibility.languages,
    },
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSettings({ showPhoto: checked })
                  }
                />
              </div>
              <p className="text-sm text-muted-foreground">
