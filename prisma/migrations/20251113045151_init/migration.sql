...
-- CreateTable
CREATE TABLE "linkedin_import_session" (
    "id" TEXT NOT NULL,
    "sessionId" TEXT NOT NULL,
    "data" JSONB NOT NULL,
    "expiresAt" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "linkedin_import_session_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "linkedin_import_session_sessionId_key" ON "linkedin_import_session"("sessionId");

-- CreateIndex
CREATE INDEX "linkedin_import_session_expiresAt_idx" ON "linkedin_import_session"("expiresAt");
...
-- AddForeignKey
ALTER TABLE "MockQuestion" ADD CONSTRAINT "MockQuestion_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "ai_mock_session"("id") ON DELETE CASCADE ON UPDATE CASCADE;
