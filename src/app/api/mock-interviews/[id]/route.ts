...
export async function GET(
  ...
  try {
    ...
    const interviewData = {
      ...interview,
      conversationLog: interview.conversationLog ? JSON.parse(interview.conversationLog) : null,
      feedback: interview.feedback ? JSON.parse(interview.feedback) : null,
      specificScores: interview.specificScores ? JSON.parse(interview.specificScores) : null,
    };
