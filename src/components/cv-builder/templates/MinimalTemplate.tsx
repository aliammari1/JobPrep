...
export function MinimalTemplate({ cvData, settings }: TemplateProps) {
  ...
  return (
    <div
      className="min-h-[297mm] bg-white p-16 text-gray-800"
      style={{ fontFamily: "Helvetica, sans-serif" }}
    >
      {/* Header - Minimal */}
      <div className="mb-10">
        <h1 className="mb-1 text-5xl font-light">
          {personalInfo.fullName || "Your Name"}
        </h1>
        <p className="mb-6 text-base font-light text-gray-600">
            ...
            {experience.map((exp) => (
              <div key={exp.id}>
                ...
                {exp.description && exp.description.length > 0 && (
                  <ul className="mt-2 list-inside list-disc space-y-1 text-sm font-light text-gray-700">
            ...
            {projects.map((proj) => (
              <div key={proj.id}>
                ...
                {proj.description && proj.description.length > 0 && (
                  <ul className="mt-1 list-inside list-disc space-y-1 text-sm font-light text-gray-700">
